...
<html>
    ...
    <div id="corps">
        ...
        <div id="barre_boutons_admin">
            <div class="bouton_admin" onclick="window.location='selectPdt.php'">
              <div style="height:50px;"><img src="Images/shoesList.png" alt="Shoe" height="75" ></div>
            Lister les articles
           </div>
            <div class="bouton_admin" onclick="window.location='creerPdt.php'">
